    ...
    <div className={styles.container}>
      <div className={styles.totalRow}>
        ...
        <div className={styles.tokenStats}>
          <span>{breakdown.total_input_tokens.toLocaleString()} in</span>
          <span>·</span>
          <span>{breakdown.total_output_tokens.toLocaleString()} out</span>
        </div>
      </div>
      ...
      <div className={styles.splitGrid}>
        <div className={styles.col}>
          <h4 className={styles.colTitle}>By Model</h4>
          {breakdown.by_model.length === 0 ? (
            <p className={styles.empty}>No cost recorded.</p>
          ) : (
        ...
        <div className={styles.col}>
          <h4 className={styles.colTitle}>By Task</h4>
